...
if __name__ == "__main__":
    ...
    X, Y,profession, X_dev, Y_dev,profession_dev, X_test, Y_test, profession_test = load_glove(normalize=args.normalize)
    ...
    for filename in os.listdir("./interim/glove{}/kernel/preimage".format(run_id)):
        ...
        for kernel_type in [ "rbf", "poly","laplace","sigmoid","linear","mlp"]:
            ...
            print("-----------------------------------")
        print("=================================================")   
    directory = f"interim/glove{run_id}/kernel/preimage/eval"

    if not os.path.exists(directory):
        os.makedirs(directory)
    file_path = os.path.join(directory, "scores_with_multiple2.pickle")
